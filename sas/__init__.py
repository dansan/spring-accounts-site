...
logging.basicConfig(
    ...
    filename=f'{settings.LOG_PATH}/root_debug.log',
    filemode='w',
)


logger = logging.getLogger()
ro = logging.FileHandler(f'{settings.LOG_PATH}/root_debug.log')
...
dj = logging.FileHandler(f'{settings.LOG_PATH}/django_info.log')
...
l1 = logging.FileHandler(f'{settings.LOG_PATH}/spacc_debug.log')
...
l2 = logging.FileHandler(f'{settings.LOG_PATH}/spacc_info.log')
