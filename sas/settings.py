...
SECRET_KEY = '-c5bv6kh2nvm2inl%h^a5!+k)q.-l$=cr9ms0gfdz3c2cgur2qc'
...
AUTHENTICATION_BACKENDS = ('django_openid_auth.auth.OpenIDBackend', ) + global_settings.AUTHENTICATION_BACKENDS
